...
// from fps controller starter asset

/*
 * 
 * 
 * THIS IS CURRENTLY NOT BEING USED! WATCH OUT WHEN MAKING CHANGES!
...
namespace Player
{
	...
	{
		[Header("Player")]
		// replaced by Movement Speed from player stats
		...
		private void Move()
		{
			...
			float targetSpeed = Input.Sprint ? SprintSpeed : MovementSpeed;
